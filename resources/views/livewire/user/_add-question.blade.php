<div class="add-question">
    ...
    <form wire:submit.prevent="create">
        ...
        <div class="mb-2">
            <h2 class="w-full text-xs uppercase text-left font-bold tracking-wide mb-1 text-white">
                Correct Answer
            </h2>
        ...
        <div class="text-left">
            <x-jet-button type="submit" class="ml-2 px-2 py-1 mt-4 text-sm rounded border-gray-300">Create</x-jet-button>
        </div>
    </form>
</div>

...
<div class="add-question">
    ...
    <form wire:submit.prevent="create">
        <div class="mb-2">
            ...
            <textarea id="text" wire:model="text" class="w-full px-3 py-2 border rounded bg-black border-gray-300 text-white" rows="2"></textarea>
            @error('text')
        ...
        <div class="mb-2">
            ...
            <input id="time_limit" type="number" wire:model="timeLimit" class="w-full px-3 py-2 border border-gray-300 ring:focus rounded bg-black">
            @error('timeLimit')
            <p class="text-red-600 mt-2">{{ $message }}</p>
            @enderror
        </div>
            ...
            @foreach($options as $index => $option)
                <div class="flex items-center mb-2" wire:key="{{$index}}-option">
                    ...
                    <input type="text" wire:model="options.{{ $index }}"
                        class="w-full px-3 border border-gray-300 rounded bg-black text-white flex-1 mr-2 mb-1"
        ...
        <div class="mb-2">
            ...
            <select class="w-full px-3 py-2 border rounded bg-black border-gray-300"

<div class="max-w-screen-md mx-auto flex flex-col min-h-screen leading-none"
    ...
    <div class="fixed z-30 bottom-0 right-0 mb-12 mr-12">
        <button class="bg-pink-600 hover:bg-pink-700 text-white rounded-full shadow p-3 svg" @click="creating = true">
            <svg class="h-6" viewBox="0 0 0 20" stroke-width="2" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
    ...
    @forelse($quizzes as $quiz)
        <div class="w-full bg-black text-gray-900 py-3 px-6 rounded border shadow relative mb-4">
